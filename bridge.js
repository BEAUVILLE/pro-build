/* DIGIYLYFE ā€” Pont session commun
   Invisible pour le pro : il garde les repĆØres utiles cĆ´tĆ© tĆ©lĆ©phone
   et nettoie les liens sensibles affichĆ©s Ć  l'Ć©cran. */
(function(){
  "use strict";
  const MODULE = String(window.DIGIY_MODULE || "BUILD").toUpperCase();
  ...
  window.DIGIY_MODULE_BRIDGE = { module: MODULE, readSession, writeSession, cleanUrl, cleanVisibleUrl: cleanUrl, cleanLinks, captureFromUrl, get, set, normPhone, normSlug };
})();
